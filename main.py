...
CHANNEL_ID = os.getenv("CHANNEL_ID")       # Канал, откуда читаем сообщения
...
# Основной лист (куда бот пишет из канала)
...
async def handle_channel_post(message: types.Message):
    """Обрабатываем новые сообщения из канала"""
...
# ---------- MAIN ----------
async def main():
    logging.info("Бот запущен: мониторинг канала и заказов включен")
